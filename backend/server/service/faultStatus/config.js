 ...
 * ★ pumpWarmupMs（以及指令项 pump_warmup_ms）安全联锁也在用：规则2 流量异常、规则6 流量剧烈波动
 *   同样要等水泵预热完成才判。改这个值，故障机和安全联锁一起变。
 *   阈值告警（alarm/evaluateRules.js）也读这个值算 s.pumpWarmedUp，但现有告警规则都没用它。
...
module.exports = {
  ...
  pumpWarmupMs: 3000,       // 水泵预热宽限期（毫秒），故障②④⑤⑥ + 安全联锁规则2/6 共用；指令项 pump_warmup_ms 优先
}
