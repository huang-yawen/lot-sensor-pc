 ...
 * 【配置】字段候选名和控制值映射见 config/protocol.js，主题名见 config/mqtt.js。 */
const { DEVICE_ID_FIELDS, TIME_FIELDS, CONTROL_VALUE_MAP } = require('../config/protocol')
...
function toWireValue(value) {
  const mapping = CONTROL_VALUE_MAP || {}
