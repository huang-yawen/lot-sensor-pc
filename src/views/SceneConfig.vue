...
const quickGuide = [
  ...
  { title: '累计与滑动统计', tab: 'aggregation', description: '用统一表单配置累计值、滑动平均、波动幅度和相邻变化量。', items: ['可选择传感数据或运行状态字段', '可仅在历史图表页面、仅在汇总数据页面或两处显示', '保存时统一校验字段、精度、窗口和图表参数'] },
  ...
  { title: '需要计算的数据', tab: 'computed', description: '阻力系数、流速、换热效率、液位等工程指标，在首页专用板块展示。', items: ['系统阻力系数 K、压力陡降速率、温度变化率', '换热效率、能效比、流量-压力曲线', '累计流量、平均流速、平均温度（图表见历史图表页面）'] },
